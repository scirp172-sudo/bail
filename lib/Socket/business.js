"use strict";
const { getRawMediaUploadData } = require('../Utils/index.js');
const { parseCatalogNode, parseCollectionsNode, parseOrderDetailsNode, parseProductNode, toProductNode, uploadingNecessaryImagesOfProduct } = require('../Utils/business.js');
const { jidNormalizedUser, S_WHATSAPP_NET } = require('../WABinary/index.js');
const { getBinaryNodeChild } = require('../WABinary/generic-utils.js');
const { makeMessagesRecvSocket } = require('./messages-recv.js');
