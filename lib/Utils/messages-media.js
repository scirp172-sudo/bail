...
const { DEFAULT_ORIGIN, MEDIA_HKDF_KEY_MAPPING, MEDIA_PATH_MAP } = require('../Defaults/index.js');
const { getBinaryNodeChild, getBinaryNodeChildBuffer, jidNormalizedUser } = require('../WABinary/index.js');
const { aesDecryptGCM, aesEncryptGCM, hkdf } = require('./crypto.js');
...
exports.DEF_MEDIA_HOST = DEF_MEDIA_HOST;
