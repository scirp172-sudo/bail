...
const { KEY_BUNDLE_TYPE, WA_ADV_ACCOUNT_SIG_PREFIX, WA_ADV_DEVICE_SIG_PREFIX, WA_ADV_HOSTED_ACCOUNT_SIG_PREFIX } = require('../Defaults/index.js');
const { getBinaryNodeChild, jidDecode, S_WHATSAPP_NET } = require('../WABinary/index.js');
const { Curve, hmacSign } = require('./crypto.js');
const { encodeBigEndian } = require('./generics.js');
const { createSignalIdentity } = require('./signal.js');
